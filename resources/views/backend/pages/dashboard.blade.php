				...
				<div class="card radius-10 bg-primary">
					<div class="card-body">
						<div class="d-flex align-items-center">
							...
							<div class="widgets-icons bg-light-transparent text-white ms-auto">
					...
					<div class="product-list p-3 mb-3">
						...
						<div class="d-flex flex-column gap-3">
							<div class="d-flex align-items-center justify-content-between gap-3 p-2 border radius-10">
								<div class="">
									<img src="{{ asset('backend/images/products/14.png') }}" width="50" alt="" />
								</div>
							...
							<div class="d-flex align-items-center justify-content-between gap-3 p-2 border radius-10">
								<div class="">
									<img src="{{ asset('backend/images/products/19.png') }}" width="50" alt="" />
								</div>
								<div class="flex-grow-1">
							...
							<div class="d-flex align-items-center justify-content-between gap-3 p-2 border radius-10">
								<div class="">
									<img src="{{ asset('backend/images/products/04.png') }}" width="50" alt="" />
								</div>
								<div class="flex-grow-1">
							...
							<div class="d-flex align-items-center justify-content-between gap-3 p-2 border radius-10">
								<div class="">
									<img src="{{ asset('backend/images/products/18.png') }}" width="50" alt="" />
								</div>
								<div class="flex-grow-1">
							...
							<div class="d-flex align-items-center justify-content-between gap-3 p-2 border radius-10">
								<div class="">
									<img src="{{ asset('backend/images/products/10.png') }}" width="50" alt="" />
								</div>
								<div class="flex-grow-1">
							...
							<div class="d-flex align-items-center justify-content-between gap-3 p-2 border radius-10">
								<div class="">
									<img src="{{ asset('backend/images/products/08.png') }}" width="50" alt="" />
								</div>
								<div class="flex-grow-1">
							...
							<div class="d-flex align-items-center justify-content-between gap-3 p-2 border radius-10">
								<div class="">
									<img src="{{ asset('backend/images/products/03.png') }}" width="50" alt="" />
								</div>
								<div class="flex-grow-1">
								...
								<td>
									<div class="d-flex align-items-center">
										<div class="recent-product-img">
											<img src="{{ asset('backend/images/products/12.png') }}" alt="">
										</div>
										<div class="ms-2">
