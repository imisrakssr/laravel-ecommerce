			  ...
			  <div class="card radius-10 w-100">
				<div class="card-body">
				  <div class="d-flex align-items-center mb-3">
					...
					<a href="{{ route('district.trashManage') }}" class="btn btn-dark px-5 ms-auto">Trash Folder</a>
				  </div>
							  ...
							  <div class="modal-dialog">
							    <div class="modal-content">
							      <div class="modal-header">
							        <h1 class="modal-title fs-5" id="exampleModalLabel">Move this District to trash?</h1>
							      ...
							      <div class="modal-body text-center">
							        <div class="modal-action-btn">
							        	<ul>
							        		<li>
							        			<a href="{{ route('district.trash', $district->id) }}" class="btn btn-danger px-5">Yes</a>
							        		</li>
							        		<li>
