...
@section('page-title')
	<title>Add Product | Ecommerce Platform</title>
@endsection
							...
							<div class="col-lg-8">
								<div class="border border-3 p-4 rounded">
									...
									<div class="mb-3">
										...
										<input type="text" name="title" class="form-control" placeholder="Enter product title" value="{{ old('title') }}" required="required">
									</div>

									<div class="mb-3">
										<label class="form-label">Short Description</label>
										<textarea class="form-control" rows="4" name="short_details">{{ old('short_details') }}</textarea>
									</div>

									<div class="mb-3">
										<label class="form-label">Long Description</label>
										<textarea class="form-control" rows="7" name="long_details">{{ old('long_details') }}</textarea>
									</div>
								...
								<div class="border border-3 p-4 rounded">
									<div class="row g-3">
										...
										<div class="col-md-6">
											...
											<input type="number" class="form-control" name="regular_price" value="{{ old('regular_price') }}" placeholder="00.00">
										</div>

										<div class="col-md-6">
											<label class="form-label">Offer Price</label>
											<input type="number" class="form-control" name="offer_price" value="{{ old('offer_price') }}" placeholder="00.00">
										</div>

										<div class="col-md-6">
											<label class="form-label">SKU Code</label>
											<input type="text" class="form-control" name="sku_code" value="{{ old('sku_code') }}" placeholder="00.00">
										</div>
										...
										<div class="col-12">
											...
											<input type="text" class="form-control" placeholder="Enter Product Tags" name="tags" value="{{ old('tags') }}">
										</div>
