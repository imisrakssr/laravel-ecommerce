...
@section('page-title')
	<title>Deleted Countries | Ecommerce Platform</title>
@endsection
			  ...
			  <div class="card radius-10 w-100">
				<div class="card-body">
				  <div class="d-flex align-items-center mb-3">
					<h5 class="mb-0">Deleted Countries</h5>
					<a href="{{ route('country.manage') }}" class="btn btn-dark px-5 ms-auto">Back</a>
				  </div>
							  ...
							  <div class="modal-dialog">
							    <div class="modal-content">
							      <div class="modal-header">
							        <h1 class="modal-title fs-5" id="exampleModalLabel">Delete this Country permenently?</h1>
							      ...
							      <div class="modal-body text-center">
							        <div class="modal-action-btn">
							        	<ul>
							        		<li>
							        			<a href="{{ route('country.destroy', $country->id) }}" class="btn btn-danger px-5">Yes</a>
							        		</li>
							        		<li>
