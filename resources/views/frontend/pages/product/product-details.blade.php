...
@section('title')
    <title>Multikart - {{ $productDetails->title }}</title>
@endsection
                ...
                <div class="col-sm-6">
                    <nav aria-label="breadcrumb" class="theme-breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('all-products') }}">All Product</a></li>
                            <li class="breadcrumb-item">{{ $productDetails->slug }}</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 rtl-text">
                        <div class="product-right">
                            ...
                            <p class="short-details">{{ $productDetails->short_details }}</p>
                            ...
                            <div class="label-section">
                                ...
                                <span class="label-text badge bg-success">{{ $productDetails->category->name }} Category</span>
                            </div>

                            @if ( !is_null($productDetails->offer_price) )

                                <h3>৳{{$productDetails->offer_price}} BDT 
                                    <span class="old-price">
                                        <del>৳{{$productDetails->regular_price}} BDT
                                    </span>
                                    <!-- <span>55% off</span> -->
                                </h3>

                            @else
                                <h3>৳{{$productDetails->regular_price}} BDT</h3>
                            @endif

                            <h6 class="product-title size-text">Available Stock Quantity</h6>
